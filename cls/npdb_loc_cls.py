...
class MSG_EMS_NPDB_DIS_LN_REQ(MSG_EMS_DEFAULT_DIS_REQ):
...
typedef struct Cs_enum_dis_loc_req_t
{
   ...
   """
    ...
    def __init__(self):
        IbcfRequestMsg.__init__(self, SVC_MSG_MAGIC_COOKIE, self.getSize(), DEF_REQ_MSG_BASE, DEF_STYPE_CS_DIS_NPDB_LOC_REQ)
...
class MSG_EMS_NPDB_DIS_LN_RSP(IbcfResponseMsg):
...
typedef struct Cs_enum_dis_loc_rsp_t
{
    ...
    def __init__(self):
        IbcfResponseMsg.__init__(self, DEF_STYPE_CS_DIS_NPDB_LOC_RSP)
    ...
    def unpack(self, binary):
        print '>> DEF_STYPE_CS_DIS_NPDB_LOC_RSP unpack'
...
class NpdbLocCommand(IbcfCommand):
    ...
    def printOutputMessage(self, omsg):
        ...
        if omsg.uiSubType == DEF_STYPE_CS_DIS_NPDB_LOC_RSP: 
           print ""
