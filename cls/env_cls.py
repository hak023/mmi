...
class MSG_EMS_CS_DIS_ENV_REQ(MSG_EMS_DEFAULT_DIS_REQ):
        
    def __init__(self):
        IbcfRequestMsg.__init__(self, SVC_MSG_MAGIC_COOKIE, self.getSize(), DEF_REQ_MSG_BASE, DEF_STYPE_CS_DIS_ENV_REQ)
    
    
class MSG_EMS_CS_DIS_ENV_RSP(IbcfResponseMsg):
...
typedef struct Cs_dis_env_rsp 
{
    ...
    def __init__(self):
        IbcfResponseMsg.__init__(self, DEF_STYPE_CS_DIS_ENV_RSP)
    ...
    def unpack(self, binary):
        print '>> DEF_STYPE_CS_DIS_ENV_RSP unpack'
...
class MSG_EMS_CS_CHG_ENV_REQ(GlobalOverLoadEnv_t_REQ):
    
    def __init__(self):
        GlobalOverLoadEnv_t_REQ.__init__(self, SVC_MSG_MAGIC_COOKIE, self.getSize(), DEF_REQ_MSG_BASE, DEF_STYPE_CS_CHG_ENV_REQ)

class MSG_EMS_CS_CHG_ENV_RSP(GlobalOverLoadEnv_t_RSP):
    
    def __init__(self):
        GlobalOverLoadEnv_t_RSP.__init__(self, DEF_STYPE_CS_CHG_ENV_RSP)

###############################################################################################################################################

class EnvCommand(IbcfCommand):
    ...
    def printOutputMessage(self, omsg):
        if omsg.uiSubType == DEF_STYPE_CS_DIS_ENV_RSP:
        ...
        elif omsg.uiSubType == DEF_STYPE_CS_CHG_ENV_RSP:
           for st in omsg.m_stEnv :
               print "\t" "%17s %17s %17s %17s" % ('ITEM', 'CURRENT', 'MAX', 'OVERLOAD_CHECK')
               print "\t" "%17s"                % ('-' * 71)
