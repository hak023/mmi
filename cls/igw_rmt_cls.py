...
class MSG_EMS_IGW_DIS_RMT_REQ(IbcfRequestMsg):
...
typedef struct Cs_enum_dis_rmt_req_t
{
    ...
    def __init__(self):
        IbcfRequestMsg.__init__(self, SVC_MSG_MAGIC_COOKIE, self.getSize(), DEF_REQ_MSG_BASE, DEF_STYPE_CS_DIS_IGW_RMT_REQ)
...
class MSG_EMS_IGW_DIS_RMT_RSP(IbcfResponseMsg):
...
typedef struct Cs_enum_dis_rmt_rsp_t
{
    ...
    def __init__(self):
        IbcfResponseMsg.__init__(self, DEF_STYPE_CS_DIS_IGW_RMT_RSP)
    ...
    def unpack(self, binary):
        print '>> DEF_STYPE_CS_DIS_IGW_RMT_RSP unpack'
...
class MSG_EMS_IGW_DEL_RMT_REQ(MSG_EMS_DEFAULT_DEL_REQ):

    def __init__(self):
        IbcfRequestMsg.__init__(self, SVC_MSG_MAGIC_COOKIE, self.getSize(), DEF_REQ_MSG_BASE, DEF_STYPE_CS_DEL_IGW_RMT_REQ)

class MSG_EMS_IGW_DEL_RMT_RSP(IbcfResponseMsg):

    def __init__(self):
        IbcfResponseMsg.__init__(self, DEF_STYPE_CS_DEL_IGW_RMT_RSP)
...
class IgwRemote_t_REQ(IbcfRequestMsg):
...
class IgwRemote_t_RSP(IbcfResponseMsg):
...
class MSG_EMS_IGW_ADD_RMT_REQ(IgwRemote_t_REQ):

    def __init__(self):
        IgwRemote_t_REQ.__init__(self, SVC_MSG_MAGIC_COOKIE, self.getSize(), DEF_REQ_MSG_BASE, DEF_STYPE_CS_CRTE_IGW_RMT_REQ)


class MSG_EMS_IGW_ADD_RMT_RSP(IgwRemote_t_RSP):

    def __init__(self):
        IgwRemote_t_RSP.__init__(self, DEF_STYPE_CS_CRTE_IGW_RMT_RSP)


class MSG_EMS_IGW_CHG_RMT_REQ(IgwRemote_t_REQ):
    
    def __init__(self):
        IgwRemote_t_REQ.__init__(self, SVC_MSG_MAGIC_COOKIE, self.getSize(), DEF_REQ_MSG_BASE, DEF_STYPE_CS_CHG_IGW_RMT_REQ)

class MSG_EMS_IGW_CHG_RMT_RSP(IgwRemote_t_RSP):
    
    def __init__(self):
        IgwRemote_t_RSP.__init__(self, DEF_STYPE_CS_CHG_IGW_RMT_RSP)
        
###############################################################################################################################################
        
class IgwRmtCommand(IbcfCommand):
    ...
    def printOutputMessage(self, omsg):
        ...
        if omsg.uiSubType == DEF_STYPE_CS_DIS_IGW_RMT_RSP: 
           print ""
