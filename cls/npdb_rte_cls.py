...
class MSG_EMS_NPDB_DIS_RTE_REQ(MSG_EMS_DEFAULT_DIS_REQ):
...
typedef struct Cs_enum_dis_rte_req_t
{
   int m_nId;
    ...
    def __init__(self):
        IbcfRequestMsg.__init__(self, SVC_MSG_MAGIC_COOKIE, self.getSize(), DEF_REQ_MSG_BASE, DEF_STYPE_CS_DIS_NPDB_RTE_REQ)
...
class MSG_EMS_NPDB_DIS_RTE_RSP(IbcfResponseMsg):
...
typedef struct Cs_enum_dis_rte_rsp_t
{
    ...
    def __init__(self):
        IbcfResponseMsg.__init__(self, DEF_STYPE_CS_DIS_NPDB_RTE_RSP)
    ...
    def unpack(self, binary):
        print '>> DEF_STYPE_CS_DIS_NPDB_RSP unpack'
...
class MSG_EMS_NPDB_DEL_RTE_REQ(MSG_EMS_DEFAULT_DEL_REQ):

    def __init__(self):
        IbcfRequestMsg.__init__(self, SVC_MSG_MAGIC_COOKIE, self.getSize(), DEF_REQ_MSG_BASE, DEF_STYPE_CS_DEL_NPDB_RTE_REQ)

class MSG_EMS_NPDB_DEL_RTE_RSP(IbcfResponseMsg):

    def __init__(self):
        IbcfResponseMsg.__init__(self, DEF_STYPE_CS_DEL_NPDB_RTE_RSP)
...
class MSG_EMS_NPDB_CON_RTE_REQ(IbcfRequestMsg):
...
{           
    ...
    def __init__(self):
        IbcfRequestMsg.__init__(self, SVC_MSG_MAGIC_COOKIE, self.getSize(), DEF_REQ_MSG_BASE, DEF_STYPE_CS_CON_NPDB_RTE_REQ)
...
class MSG_EMS_NPDB_CON_RTE_RSP(IbcfResponseMsg):
...
typedef struct Cs_enum_con_rsp_t
{
    ...
    def __init__(self):
        IbcfResponseMsg.__init__(self, DEF_STYPE_CS_CON_NPDB_RTE_RSP)
...
class NpdbRoute_t_REQ(IbcfRequestMsg):
...
class NpdbRoute_t_RSP(IbcfResponseMsg):
...
class MSG_EMS_NPDB_ADD_RTE_REQ(NpdbRoute_t_REQ):

    def __init__(self):
        NpdbRoute_t_REQ.__init__(self, SVC_MSG_MAGIC_COOKIE, self.getSize(), DEF_REQ_MSG_BASE, DEF_STYPE_CS_CRTE_NPDB_RTE_REQ)


class MSG_EMS_NPDB_ADD_RTE_RSP(NpdbRoute_t_RSP):

    def __init__(self):
        NpdbRoute_t_RSP.__init__(self, DEF_STYPE_CS_CRTE_NPDB_RTE_RSP)


class MSG_EMS_NPDB_CHG_RTE_REQ(NpdbRoute_t_REQ):
    
    def __init__(self):
        NpdbRoute_t_REQ.__init__(self, SVC_MSG_MAGIC_COOKIE, self.getSize(), DEF_REQ_MSG_BASE, DEF_STYPE_CS_CHG_NPDB_RTE_REQ)

class MSG_EMS_NPDB_CHG_RTE_RSP(NpdbRoute_t_RSP):
    
    def __init__(self):
        NpdbRoute_t_RSP.__init__(self, DEF_STYPE_CS_CHG_NPDB_RTE_RSP)
        
###############################################################################################################################################
        
class NpdbRteCommand(IbcfCommand):
...
typedef struct EnumRoute_t
{
    ...
    def printInputMessage(self, imsg):
        ...
        #if imsg.m_nStatus != -1:    
        #    print "\t" "%12s = %s" % ('STATUS', self.reprHlrStsIntToStr(imsg.m_nStatus))       
    ...
    def printOutputMessage(self, omsg):
        ...
        if omsg.uiSubType == DEF_STYPE_CS_DIS_NPDB_RTE_RSP: 
           print ""
